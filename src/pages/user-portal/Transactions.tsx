...
export default function Transactions() {
  ...
  const transactionsLoadable =
    useRecoilValueLoadable<Transaction[]>(fetchTransactions);
  ...
  const transactions: Transaction[] =
    transactionsLoadable.state === "hasValue"
      ? transactionsLoadable.contents
      : [];
        ...
        <div className="w-full sm:w-2/3 mb-4">
          <div className="bg-primary flex justify-between w-full p-5 rounded-lg items-center border border-gray-800 space-y-1">
            <div>
              ...
              <p className="text-white text-3xl font-bold">₹{"220.00"}</p>
            </div>
          </div>
              ...
              return (
                <button
                  ...
                  className={`flex justify-center items-center w-8 h-8 rounded-lg border border-gray-800 font-poppins text-color ${
                    pageNumber === currentPage ? "bg-[#161251]" : "bg-primary "
                  }`}
