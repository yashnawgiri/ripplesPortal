...
export default function HowDoesItWork() {
    return (
        <div
            className="max-w-7xl flex flex-col border border-[#282D45] md:rounded-xl bg-gradient-to-br from-[#0e194e] to-[#0c3345] p-10 my-28">
            <div className="p-4 text-center">
                <h2 className="font-bold w-full text-4xl lg:text-5xl bg-clip-text text-transparent bg-gradient-to-b from-white to-gray-400">How
                    does it work?</h2>
                <p className="w-full mt-6 mb-6 md:mb-16 text-base text-gray-500">Use our Shopify/Ecommerce Site plugin &
                    Saas that gamifies user experience post purchase to ensure they become your brand advocates</p>
            </div>
            <div className="relative">
                ...
                <div className="flex flex-wrap md:justify-between justify-center gap-8 px-6 pb-2 relative">
                    {dashboardData.HowDoesItWorkData.map(step => (
                        <div key={step.number}
                             className="flex flex-col items-center mx-auto text-center w-fit md:w-80 relative">
