                ...
                <div className="p-8">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div
                        key={index}
                        className="flex justify-between items-center p-4 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-colors duration-300"
                      >
                        <div className="flex items-center">
