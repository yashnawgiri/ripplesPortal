        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8 animate-fadeIn">
            <div className="space-y-6">
              <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-white leading-[1.1] font-poppins">
                The Influencer & UGC{" "}
          ...
          <div className="relative animate-fadeIn">
            ...
            <div className="absolute -top-8 -left-8 w-16 h-16 bg-secondary rounded-full opacity-20 animate-pulse blur-xl"></div>
            <div className="absolute -bottom-8 -right-8 w-12 h-12 bg-[#CA00E8] rounded-full opacity-30 animate-pulse delay-1000 blur-xl"></div>

            <div className="bg-[#18082A] rounded-3xl p-10 shadow-3xl border border-[#2E1A47] backdrop-blur-sm">
