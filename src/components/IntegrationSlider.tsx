  ...
  const categories: IntegrationCategory[] = [
    {
      ...
      brands: [
        {
          name: "Razorpay",
          logo: "https://ripples1static.blob.core.windows.net/images/razorpay_logo.png",
        },
        {
          name: "Gokwik Checkout",
          logo: "https://ripples1static.blob.core.windows.net/images/gokwik_logo.png",
        },
        {
          name: "Razorpay Magic Checkout",
          logo: "https://ripples1static.blob.core.windows.net/images/razorpay_checkout_magic_logo.jpg",
        },
        {
          name: "Shopflo Checkout",
          logo: "https://ripples1static.blob.core.windows.net/images/shopflo_logo.svg",
        },
        {
          name: "Klaviyo",
          logo: "https://ripples1static.blob.core.windows.net/images/klaviyo_logo.svg",
        },
        {
          name: "Razorpay",
          logo: "https://ripples1static.blob.core.windows.net/images/razorpay_logo.png",
    ...
    },
    {
      ...
      brands: [
        {
          name: "QuickReply",
          logo: "https://ripples1static.blob.core.windows.net/images/quick_reply_logo.png",
        },
        {
          name: "Interakt",
          logo: "https://ripples1static.blob.core.windows.net/images/Interakt-Logo.svg",
        },
        {
          name: "BusinessonBot",
          logo: "https://ripples1static.blob.core.windows.net/images/BusinessOnBot_logo.png",
        },
        {
          name: "Wati",
          logo: "https://ripples1static.blob.core.windows.net/images/wati_logo.svg",
        },
        {
          name: "BusinessonBot",
          logo: "https://ripples1static.blob.core.windows.net/images/BusinessOnBot_logo.png",
    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-8 overflow-hidden relative">
      ...
      <div className="text-center mb-4">
        ...
        <p className="text-lg text-white max-w-3xl mx-auto">
          Send various WhatsApp messages based on actions on Ripples, customers
          can redeem cashbacks directly on checkout, automate WhatsApp & email
          nudges.
        </p>
      </div>
          ...
          <div key={index} className="relative">
            ...
            >
              <div className="scrolling-wrapper">
                {[...category.brands, ...category.brands].map(
                  (brand, brandIndex) => (
                    <div
