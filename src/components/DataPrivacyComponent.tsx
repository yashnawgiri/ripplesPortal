...
const DataPrivacyComponent: React.FC = () => {
  return (
    <div className="flex flex-1 justify-start flex-wrap  items-center w-svw bg-primary mt-8">
      <div className="">
        <img alt="data privacy" height={"100%"} src={privacyImage} />
      </div>
      <div className="bg-primary p-8 text-white rounded-lg max-w-md text-center md:text-left">
        <h2 className="md:text-left text-6xl font-bold mb-4">Your data?</h2>
        <h3 className="md:text-left text-2xl font-semibold mb-6">
