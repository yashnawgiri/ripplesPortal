    ...
    return (
        <div className="max-w-7xl w-full space-y-6 mt-14">
            ...
            <div className="space-y-4 lg:space-x-4 lg:flex lg:justify-center lg:space-y-0">
                <div className="lg:mx-4 mx-auto h-60 px-7 py-8 max-w-sm lg:max-w-md flex flex-col border border-[#0e1536] rounded-xl bg-gradient-to-tr from-[#0e194e] to-[#081d2d]">
