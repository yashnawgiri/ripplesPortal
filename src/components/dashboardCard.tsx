...
export default function DashboardCard() {
    return (
        <div className="max-w-7xl w-full lg:flex lg:justify-between">
            {dashboardData.dashboardCardData.map(item => (
                <div key={item.icon} className="w-[410px] rounded-md bg-opacity-35 border border-gray-700 overflow-hidden shadow-lg p-8 bg-[#0e1330]">
