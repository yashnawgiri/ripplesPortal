        ...
        <footer className="bg-custom-radial2 w-full">
            <div className="max-w-7xl pt-24 pb-12 mx-auto ">
                <div className="text-center md:text-start md:flex md:justify-between">
                    <div className="mb-6">
                        <a href="#" className="md:flex items-center">
                            <h1 className="self-center text-4xl font-bold whitespace-nowrap text-white">Ripples<span
                                className="text-lg"> </span><span className="text-4xl text-[#7214FF]">.</span></h1>
                        </a>
                    </div>
                ...
                <div className="flex items-center justify-between">
                    <span className="px-2 md:px-0 text-sm md:text-lg text-gray-500">Copyright © 2024 <a href="#"
                                                                                                        className="hover:underline">Ripples</a></span>
