    ...
    return (
        <div
            ...
            <div className="flex justify-between">
                <h1 className="py-4 pl-10 text-xs md:text-3xl font-bold text-white">{question}</h1>
                {isOpen ? (
            ...
            {isOpen && <p className="text-gray-400 text-xs md:text-base pb-4 pt- md:pb-6 pl-10 pr-16">{answer}</p>}
        </div>
    );
};
    ...
    return (
        <div className="max-w-7xl w-full space-y-8">
            <div className="text-center">
                <h1 className={`${title({size: 'lg', color: 'foreground', weight: 'bold'})} h-20`}>Frequently Ask
                    Questions</h1>
