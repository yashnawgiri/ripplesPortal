    ...
    <div className="w-full max-w-full overflow-hidden">
      <section className="py-6 sm:py-8 md:py-12 lg:py-16 relative bg-transparent">
        ...
        <div className="relative w-full overflow-hidden">
          {/* Left gradient fade */}
          <div className="absolute left-0 top-0 bottom-0 w-6 sm:w-4 md:w-8  z-10 pointer-events-none bg-gradient-to-r from-[#999999] via-[#e4e4e4] to-transparent"></div>
          
          {/* Right gradient fade */}
          <div className="absolute right-0 top-0 bottom-0 w-6 sm:w-4 md:w-8 z-10 pointer-events-none bg-gradient-to-l from-[#a7a7a7] via-[#d8d8d8] to-transparent"></div>
